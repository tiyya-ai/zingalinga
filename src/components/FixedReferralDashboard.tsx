...
import { ClientOnly, useIsClient, safeRandom } from '../utils/clientOnly';
...
export default function FixedReferralDashboard({ 
  user, 
  modules = [], 
  purchases = [], 
  contentFiles = [], 
  ...
  function generateReferralCode(userId: string): string {
    const randomPart = isClient ? Math.random().toString(36).substr(2, 4).toUpperCase() : 'ABCD';
    return `REF${userId.slice(0, 4).toUpperCase()}${randomPart}`;
  }
        ...
        <CardBody className="p-6">
          <div className="bg-white/5 rounded-lg p-4 mb-4">
            <div className="flex items-center justify-between">
              <div>
                <ClientOnly fallback={<div className="text-2xl font-bold text-white mb-1">Loading...</div>}>
        ...
        <div className="bg-white/10 backdrop-blur-md border-b border-white/20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center justify-between h-16">
              <div className="flex items-center gap-4">
                <ClientOnly fallback={<div className="w-12 h-12 bg-gray-300 rounded-full" />}>
                  <Avatar
                    size="md"
